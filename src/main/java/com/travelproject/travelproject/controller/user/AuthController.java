...
import com.travelproject.travelproject.dto.request.auth.FindPasswordRequestDto;
...
public class AuthController {
    ...
    public ResponseEntity<? super ResponseDto> getUserEmail(
        @Valid @RequestBody FindEmailRequestDto requestBody
    ) {
    ...
    public ResponseEntity<FindPasswordResponseDto> findPassword(
        ...
        FindPasswordResponseDto responseDto = findPasswordService.resetPassword(requestBody.getUserEmail(), requestBody.getUserPhonenumber());
