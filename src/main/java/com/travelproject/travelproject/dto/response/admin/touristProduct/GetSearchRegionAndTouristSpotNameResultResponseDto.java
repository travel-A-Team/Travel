...
@Data
public class GetSearchRegionAndTouristSpotNameResultResponseDto extends ResponseDto {
    List<TouristSpotDto> touristSpotList;

    public GetSearchRegionAndTouristSpotNameResultResponseDto(List<TouristSpotEntity> touristSpotEntities) {
